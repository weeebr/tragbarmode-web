...
console && console.log('ViewSingleElement.js is loaded');
// Come from vc_map -> 'js_view' => 'ViewSingleElement'
var Shortcodes = vc.shortcodes;

window.ViewSingleElement = window.VcColumnView.extend({
    	 events:{
    ...
    render:function () {
            ...
            // console && console.log('ViewSingleElement.params:'+params);
            window.ViewSingleElement.__super__.render.call(this);
           // console && console.log('ViewSingleElement.render() is loaded');
            if(!params.tab_id) {
            ...
            this.$el.attr('id', this.id);
             //console && console.log('ViewSingleElement.render() end');
            return this;
        },
	   ready:function (e) {

            window.ViewSingleElement.__super__.ready.call(this, e);
            this.$tabs = this.$el.closest('.wpb_tabs_holder');
            var params = this.model.get('params');
             //console && console.log('ViewSingleElement.ready() loading');
            return this;
        },
        changeShortcodeParams:function (model) {
             var params = model.get('params');
            window.ViewSingleElement.__super__.changeShortcodeParams.call(this, model);
             //var params = model.get('params');
            ...
            //console && console.log('ViewSingleElement changeShortcodeParams loading');
        },
        deleteShortcode:function (e) {
           ...
           // console && console.log('ViewSingleElement.deleteShortcode loading');
        },
        cloneModel:function (model, parent_id, save_order) {
            ...
            console && console.log('ViewSingleElement.cloneModel loading');
            return model_clone;
        }
