...
window.ViewTestElement = vc.shortcode_view.extend({
	...
	initialize:function (params) {
            ...
            window.ViewTestElement.__super__.initialize.call(this, params);
            _.bindAll(this, 'stopSorting');
           //console && console.log('ViewTestElement: initialize method called.');
        },
	...
	render: function () {
        ...
        //console &&  console.log('ViewTestElement '+this.$tabs);
		return this;
	},
	ready: function (e) {
    ...
    createAddTabButton:function(){
    	var new_tab_button_id = (+new Date() + '-' + Math.floor(Math.random() * 11));
         ...
         //console &&  console.log(' ViewTestElement : createAddTabButton');
        },
    addTab:function (e) {
    	//console &&  console.log('addTab');
            ...
            //console &&  console.log(' ViewTestElement :  addTab');
            return false;
        },
        stopSorting:function (event, ui) {
            var shortcode;
             console &&  console.log(' ViewTestElement :  stopSorting loading');
            this.$tabs.find('ul.tabs_controls li:not(.add_tab_block)').each(function (index) {
              ...
              //console &&  console.log(' ViewTestElement :  shortcode save');
            shortcode.save();
        },
       changedContent:function (view) {
            ...
            //console &&  console.log(' ViewTestElement :  changedContent save');
        },
