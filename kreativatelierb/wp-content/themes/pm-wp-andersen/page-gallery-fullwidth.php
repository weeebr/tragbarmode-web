...
?>
    ...
    <!-- Content -->
    <div class="supersized_here gallery_type_5 pm_gallery" data-thumbs-count="10" data-min-thumbs-count="5"
         data-thumbs-border-size="10">
