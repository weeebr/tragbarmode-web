...
function pm_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'            => get_stylesheet_directory() . '/kitchen/tgm/src/js_composer.zip', // The plugin source
        ...
        array(
            ...
            'source'            => get_stylesheet_directory() . '/kitchen/tgm/src/Ultimate_VC_Addons.zip', // The plugin source
            'required'          => true, // If false, the plugin is only 'recommended' instead of required
            'version'           => '3.12.0.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ),
    );
