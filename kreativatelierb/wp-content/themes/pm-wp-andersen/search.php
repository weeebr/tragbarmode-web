                            ...
                            <div class="span12">
                                <div class="container blog_listing_style2 pspike1">
                                    ...
                                    if (have_posts()) {
                                        while (have_posts()) {
                                            ...
                                            <div class="pm_post">
                                                ...
                                                <p class="pm_excerpt">
                                                    ...
                                                    ?>
                                                    <a href="<?php the_permalink(); ?>"><?php echo __('Read more &gt;', 'pm_local'); ?></a>
                                                </p>
                                            </div>
                                            <?php
                                        }
                                        ...
                                        echo '<h2 class="tac opnf">'.__('Oops! Nothing Found!', 'pm_local').'</h2>';
                                    echo '<div class="search404">';
...
<script>
    jQuery(window).load(function (e) {
        ...
        jQuery('.content.container').addClass('height_auto');
    });
</script>