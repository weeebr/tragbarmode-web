                ...
                <div class="row">
                    <div class="span12 texts_area">
                        <article>
                            ...
                            <div class="projects">
                                <h4 class="preview_headers"><?php echo __('recent posts', 'pm_local'); ?></h4>
...
";
    ...
    <!-- Content -->
    <div <?php post_class("content container single_style"); ?>>
                                ...
                                <div class="container blog_listing_style2">
                                    ...
                                    <div class="row pm_relared_row">
                                        ...
                                        while ($pm_the_query->have_posts()) {
                                            ...
                                            <div class="span6">
                                                <div class="pm_related_stand <?php echo (strlen($pm_recent_featured_image_url) < 1 ? 'without_fimage' : ''); ?>">
                                        ...
                                        <div class="pm_dn"><?php posts_nav_link(); ?></div>
