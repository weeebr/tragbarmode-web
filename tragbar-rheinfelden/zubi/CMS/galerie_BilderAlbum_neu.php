            ...
            <table border="0" class="pageframe" width="100%" height="100%">
				...
				<tr height="*">
					...
					<td colspan="2">
						...
						<h1>Neues Album hinzuf&uuml;gen</h1>
						<p>
						<form action='galerie_Album_neu_speichern.php' method='post'>
						<table style="border-collapse: collapse;" border = "0">
						<tr>
							<td>Name:</td>
							<td><input type="text" name="AlbumName" id="AlbumName" size="50"></td>
						</tr>
						<tr>
							<td>Kommentar:</td>
							<td><textarea name="AlbumKommentar" id="AlbumKommentar" rows="5" cols="38"></textarea>
						</tr>
						<tr>
							<td colspan="2" align="center"><input type="image" src="img_page/knoepfe/AlbumHinzufuegen.png" width="100">
