            ...
            <table border="0" class="pageframe" width="100%" height="100%">
				...
				<tr height="*">
					...
					<td colspan="2">
						...
						<td class="registerActive" align="center" width="20%"><a href="gaestebuch_freigegebene_bearbeiten.php">Freigegebene Eintr&auml;ge bearbeiten</a></td>
						...
						while ($row = mysqli_fetch_array($ergebnis))
							{
								...
								echo "<td rowspan='2' width='300' align='center'><a href='gaestebuch_freigegebene_bearbeiten_sperren_ausfuehren.php?id=" .$senderid. "'><img src='img_page/knoepfe/Sperren.png' width='100'></a></td>";
								echo "</tr>";
								echo "<tr>";
