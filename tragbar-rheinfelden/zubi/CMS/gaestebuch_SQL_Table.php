            ...
            <table border="0" class="pageframe" width="100%" height="100%">
				...
				<tr height="*">
					...
					<td colspan="2">
						...
						<td class="registerActive" align="center" width="20%"><a href="gaestebuch_SQL_Table.php">Vollst&auml;ndige SQL-Tabelle</a></td>
						...
						?>
						<h1>Vollst&auml;ndige SQL-Ansicht der Tabelle G&auml;stebuch</h1>
						<p>
						<?php
						...
						echo "<tr>";
						echo "<td class='TabelleUeberschrift'>ID</td>";
						echo "<td class='TabelleUeberschrift'>Sendername</td>";
						echo "<td class='TabelleUeberschrift'>Sendermail</td>";
						echo "<td class='TabelleUeberschrift'>Senderhomepage</td>";
						echo "<td class='TabelleUeberschrift'>Nachricht</td>";
						echo "<td class='TabelleUeberschrift'>Datum</td>";
						echo "<td class='TabelleUeberschrift'>Status</td>";
						echo "</tr>";
						...
						<p>
						<b><u>Legende Status:</u></b><br>
						0 = Direkt mit SQL Eingef&uuml;gt (z.B. mit phpMyAdmin), auf Webseite nicht sichtbar.<br>
						<font color="#FF0000">1 = Freigegebener Eintrag, auf Webseite sichtbar.</font><br>
						<font color="#FFFF00">2 = Noch nicht freigegebener Eintrag, auf Webseite nicht sichtbar.</font><br>
						<font color="#00FF00">3 = Gesperrter Eintrag, auf Webseite nicht sichtbar.</font>
						</p>
					</td>
				</tr>
			</table>
