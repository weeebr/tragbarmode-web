            ...
            <table border="0" class="pageframe" width="100%" height="100%">
				...
				<tr height="*">
					...
					<td colspan="2">
						...
						<p>
						<a href="galerie_BilderAlbum_neu.php"><img src="img_page/knoepfe/plus.png" height="15"><font style="font-size:x-large;"> Album hinzuf&uuml;gen</font></a>
						</p>
						<hr>
						<p>
