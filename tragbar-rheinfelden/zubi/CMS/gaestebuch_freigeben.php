            ...
            <table border="0" class="pageframe" width="100%" height="100%">
				...
				<tr height="*">
					...
					<td colspan="2">
						...
						<tr>
						<td class="registerActive" align="center" width="20%"><a href="gaestebuch_freigeben.php">Eintr&auml;ge freigeben</a></td>
						...
						if (isset($_GET['SperrenOK'])) {
							echo '<p class="loggedout" align="center">Der Eintrag wurde erfolgreich gesperrt.</p>';
						}
						?>
						<h1>Offene Eintr&auml;ge freigeben</h1>
						<p>
						<?php
						...
						$ergebnis = mysqli_query($db, "SELECT * FROM gaestebuch WHERE status='2' ORDER BY datum DESC");
						if($ergebnis !== 0)
						{
						while ($row = mysqli_fetch_array($ergebnis))
							{
								...
								echo "<td rowspan='2' width='300' align='center'><a href='gaestebuch_freigeben_ausfuehren.php?id=" .$senderid. "'><img src='img_page/knoepfe/freigeben.png' width='100'></a> &nbsp; ";
								echo "<a href='gaestebuch_FreigebenSperren_ausfuehren.php?id=" .$senderid. "'><img src='img_page/knoepfe/sperren.png' width='100'></a>";
								echo "</td>";
								echo "</tr>";
								echo "<tr>";
