...
FCKConfig.ToolbarSets["USOLVED"] = [
	['FitWindow','-','Preview','-','Source'],
	'/',
		['Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Outdent','Indent','-','OrderedList','UnorderedList','-','Link','Unlink','-','Table','-','TextColor','BGColor'],
	'/',
